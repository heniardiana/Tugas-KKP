...
<li><?php include("kat.php");?></li>
    ...
    <div class="jumbotron">
     ...
     <img src="img/logo bopang.jpg">   
    </div>
      <div class="col-md-6" style="margin-left:70px; margin-top: 80px;">
        <h2><b>Selamat datang di Keripik.<h1 style="color:#f97b61;">BOPANG</h1></h2>
        <p>Disini anda bisa membeli dan memesan Keripik dengan mudah, anda tinggal klik, maka keripik kesayangan anda sampai di tempat anda. tidak perlu lagi jauh jauh ke toko offline kami.</p>
      </div>
    </div>
    </div>
...
Cara Pesan
    ...
    <br>
          4. Selanjutnya produk yang telah dipesan akan dikirimkan dalam waktu maksimal 7 Hari.<br>
          5. Kami mengirimkan barang dengan menggunakan jasa pengiriman barang via POST<br><br></b></p>
		<p style="color:red;">* Harga produk belum termasuk ongkos kirim, dan ongkos kirim akan disesuaikan dengan tujuan pengiriman.</p></h3>
    </div>
    </div>
