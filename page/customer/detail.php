...
include"../../koneksi.php";
@$kd = $_GET['id'];
$qry = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * from produk where id_produk='$kd'");
...
<input type="text" name="alamat" placeholder="jalan/Dusun/Desa/Kecamatan/Kabupaten/Provinsi/kode pos" class="form-control" required><br>
<label>Nomor Telepon</label>
<input type="text" name="nomor_tlp" placeholder="Nomor Telepon Anda" class="form-control" required><br>
<label>Tanggal</label>
...
<input type="submit" class="btn btn-info" value="selesai">
 ...
 <?php }else{
    ...
    <div class="jumbotron">
      <div class="row">
      <div class="col-md-3 save_money twenty-percent2" style="margin:30px;">
     <img src="../../gambar/<?php echo $data['gambar']; ?>" style="width:250px; height:250px;">   
      ...
      <div class="col-md-6" style="margin-left:10px ; margin-top:10px;">
        <table>
          ...
          <tr>
            <h3><td><b>Harga</b></td>   <td>: Rp. <h7 style="text-decoration: line-through;"><?php echo rupiah($data['harga']); ?>,-</h7>
            <?php $diskon=(($data['harga']*15)/100); ?>
          <?php echo rupiah($data['harga']-$diskon); ?>,-</td></h3>
          </tr>
...
<div class="container">
     <div class="row">
      ...
      <div class="col-md-3" style="margin-top:20px;">
        <div class="produk save_money twenty-percent">
        <center><img src="../../gambar/<?php echo $produk['gambar'] ?>" style="margin-top:20px; width:200px;height:190px;"></center>
         <h3 style="text-align:center; color:#f97b61;"><?php echo $produk['rasa'] ?></h3>
          <center><b>Harga</b> Rp.<h7 style="text-decoration: line-through;"><?php echo rupiah($produk['harga']);?>,-</h7> 
          <?php $diskon=(($produk['harga']*15)/100); ?>
          <?php echo rupiah($produk['harga']-$diskon); ?>,-</center>
