...
if($_FILES['gambar']['name']){
	...
	if(!$_FILES['gambar']['error']){
		...
		if($valid_file == true)
		{
			...
			mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE produk set rasa='$rasa',id_ketegori='$id_kategori',tgl_produksi='$tgl_produksi',tgl_kadaluarsa='$tgl_kadaluarsa',harga='$harga_new', gambar='$nama_file_baru', stok='$stok' where id_produk='$id_produk'");
